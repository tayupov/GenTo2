...
>>>>>>> added events in StandartTokenWithShareholderList.sol for testing, modified the getShareholderCounts method, added a new method getBalance, and inserted in every method public modifier because its nessecary for testing
