...
module.exports = async function(deployer, network, accounts) {
  ...
  await GentoFactory.createDAO.sendTransaction(web3.toWei(100, "ether"), "YAY", "Theo Software Solutions", theosHash, 1, 10, 0, 100, 40, 20, 30, 10)
  await GentoFactory.createDAO.sendTransaction(web3.toWei(100, "ether"), "RBR", "Rolls by the Roman", romansHash, 1, 10, 0, 100, 40, 20, 30, 10)
  await GentoFactory.createDAO.sendTransaction(web3.toWei(100, "ether"), "PP", "Project Paul", paulsHash, 1, 10, 0, 100, 40, 20, 30, 10)
