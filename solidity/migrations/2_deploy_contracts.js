...
module.exports = async function(deployer, network, accounts) {
  ...
  await paul.newProposal.sendTransaction("Test Proposal", "Wer hier abstimmt ist doof", "0x257c1440ef68c42cb5ccc0738883e39253719610", 1, 0, {from: accounts[1]})

  await paul.setCurrentTime.sendTransaction(1200)
  await paul.newProposal.sendTransaction("Test Proposal2", "Wer hier abstimmt ist doof", "0x257c1440ef68c42cb5ccc0738883e39253719610", 1, 0, {from: accounts[1]})
  await paul.setCurrentTime.sendTransaction(1800)
  await paul.newProposal.sendTransaction("Test Proposal3", "Wer hier abstimmt ist doof", "0x257c1440ef68c42cb5ccc0738883e39253719610", 1, 0, {from: accounts[1]})
